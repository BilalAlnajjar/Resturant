						...
						<div class="card">
							...
							<div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Product Name" value="{{$offer->name}}">
                                    @error('name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
									...
									<div class="form-group">
													...
													<input type="text" class="form-control" name="price" placeholder="new price" value="{{$offer->price}}">
												</div>
