											...
											<table id="example" class="table table-striped table-bordered text-nowrap w-100">
												...
												<tbody>
													<tr>
                                                        ...
                                                        <td>$20</td>
														<td>2018/03/12</td>
														<td><a class="btn btn-sm btn-primary" href="view_order.php"><i class="fa fa-edit"></i> Edit</a>
															<a class="btn btn-sm btn-danger" href="#"><i class="fa fa-trash"></i> Delete</a>
														</td>
														<td><a class="btn btn-sm btn-secondary" href="view_order.php"><i class="fa fa-info-circle"></i> View</a> </td>
                                                    </tr>
                                                    <tr>
														<td>2</td>
