...
<div class="card">
    <form @if($placeItem) action="{{route('place.update',$placeItem->id)}}" @endif @if(!$placeItem)action="{{route('place.store')}}"@endif method="POST" enctype="multipart/form-data">
    @csrf
    @if($placeItem)
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="name" placeholder="Customer Name" @if($placeItem) value="{{$placeItem->name}}" @endif>
                        @error('name')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="price" placeholder="Delivery Price" @if($places->first()) value="{{$places->first()->price}}" @endif>
                        @error('price')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('place.edit',$place->id)}}" class="btn btn-sm btn-success text-white"
