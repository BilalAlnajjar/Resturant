...
<div class="card">
    <form @if($addition) action="{{route('addition-subcategory.update',$addition->id)}}" @endif action="{{route('addition-subcategory.store')}}" method="Post">
        @if($addition)
    ...
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 custom-select" data-placeholder="Choose one" name="addition_category_id" id="addition_category_id">
                        ...
                        @if($addition)
                        <option value="{{$addition->category_addition()->first()->id}}" selected>{{$addition->category_addition()->first()->name}}</option>
                        @foreach ($additions_category as $addition_category)
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" placeholder="new price" @if($addition) value="{{$addition->price}}" @endif>
                </div>

                <div class="col-4">
                    <label class="form-label">
                    <input type="checkbox"  name="count" @if($addition) @if($addition->count == 'on') checked @endif @endif>
            ...
            <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="{{route('addition-subcategory.edit',$sub_addition->id)}}"><i class="fa fa-edit"></i> Edit</a>
...
<form method="POST"  action="{{route('addition-subcategory.destroy',$sub_addition->id)}}">
    @csrf
