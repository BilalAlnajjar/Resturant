...
<div class="card">
    <form @if(!$addition) action="{{route('addition-category.store')}}" @endif @if($addition) action="{{route('addition-category.update',$addition->id)}}" @endif method="Post">
        @if($addition)
            ...
            <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="{{route('addition-category.edit',$category_addition->id)}}"><i class="fa fa-edit"></i> Edit</a>
...
<form method="POST" action="{{route('addition-category.destroy',$category_addition->id)}}">
    @csrf
