...
<div class="card">
    <form @if($video) action="{{route('video.update')}}" @endif @if(!$video) action="{{route('video.store')}}" @endif  method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="link" class="form-control" name="link" placeholder="Video Link" @if($video) value="{{$video->link}}" @endif>
                        @error('link')
