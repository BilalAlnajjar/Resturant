			...
			<div class="side-app x-active">
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
							<div class="card-body">
								<div class="btn-list">
									<a href="add_social.php"><button" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Add</button></a>
								</div>											
							</div>
					</div><!-- COL END -->
				</div>
				...
				<div class="row row-cards row-deck">
					<div class="col-md-4">
						<div class="card">
							...
							<div class="card-body">
								<a class="btn btn-sm btn-primary" href="add_social.php"><i class="fa fa-edit"></i> Edit</a>
